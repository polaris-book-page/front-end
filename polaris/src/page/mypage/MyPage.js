            ...
            <CardBox>
              ...
              <ContentBox>
                <ProfileTitleBox>
                  ...
                  <ProfileSubTitleText onClick={() => navigate('/mypage/universe')}>리뷰 목록</ProfileSubTitleText>
                  <ProfileSubTitleText onClick={() => navigate('/mypage/review')}>우주를 향유하러</ProfileSubTitleText>
                </ProfileTitleBox>
